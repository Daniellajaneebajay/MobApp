...
const styles = StyleSheet.create({
  ...
  welcome: { fontFamily: 'Poppins_700Bold', fontSize: 24, color: '#000000', marginBottom: 8 },
  brand: { flexDirection: 'row', marginBottom: 16 },
  hydro: { color: '#24009C', fontFamily: 'Poppins_700Bold', fontSize: 42 },
  verde: { color: '#43671A', fontFamily: 'Poppins_700Bold', fontSize: 42 },
  subtitle: { fontFamily: 'Inter_600SemiBold', fontSize: 15, color: '#000000', textAlign: 'center', lineHeight: 30, marginBottom: 36, paddingHorizontal: 12 },
